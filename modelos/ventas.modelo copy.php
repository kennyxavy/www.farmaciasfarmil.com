...
class VentasModelo
{
    ...
    static public function mdlRegistrarVenta($datos, $nro_boleta, $total_venta, $descripcion_venta, $ruc_cliente, $nombres_apellidos_cliente, $email_cliente)
    {

        $stmt = Conexion::conectar()->prepare("INSERT INTO venta_cabecera(nro_boleta, descripcion, total_venta, ruc_cliente, nombres_apellidos_cliente, email_cliente)         
        VALUES(:nro_boleta, :descripcion, :total_venta, :ruc_cliente, :nombres_apellidos_cliente, :email_cliente)");
        ...
        $stmt->bindParam(":ruc_cliente", $ruc_cliente, PDO::PARAM_STR);
        $stmt->bindParam(":nombres_apellidos_cliente", $nombres_apellidos_cliente, PDO::PARAM_STR);
