     ...
     $(document).ready(function() {
         ...
         $.ajax({
             ...
             success: function(respuesta) {
                 // console.log("respuesta", respuesta);
                 $("#totalProductos").html(respuesta[0]['totalProductos']);
                 $("#totalCompras").html('$' + formatoNumero(respuesta[0]['totalCompras']));
                 $("#totalVentas").html('$' + formatoNumero(respuesta[0]['totalVentas']));
                 $("#totalGanancias").html('$' + formatoNumero(respuesta[0]['ganancias']));
                 $("#totalProductosMinStock").html(respuesta[0]['productosPocoStock']);
                 $("#totalVentasHoy").html('$' + formatoNumero(respuesta[0]['ventasHoy']));
             }
         });
         ...
         $.ajax({
             ...
             success: function(respuesta) {
                 ...
                 $("#title-header").html('Ventas del Mes: $ ' + total_ventas_mes.toFixed(2).replace(
                     /\B(?=(\d{3})+(?!\d))/g, ","));
