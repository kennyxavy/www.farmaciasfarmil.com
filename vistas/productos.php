            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group mb-2">
                                <label class="" for="iptMarcaReg"><i class="fab fa-apple fs-6"></i> <span
                                        class="small">Marca</span><span class="text-danger">*</span></label>
                        ...
                        <div class="col-6 col-lg-2">
                            <div class="form-group mb-2">
                                <label class="" for="iptUbicacionReg"><i class="fas fa-map-marker-alt fs-6"></i> <span
                                        class="small">Ubicación</span><span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                <label class="" for="iptFechaVencimientoReg"><i class="far fa-calendar-alt fs-6"></i>
                                    <span class="small">Fecha de caducidad</span><span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" name="iptFechaVencimientoReg" step="1"
                                    min="2023-01-01" max="2030-12-31" value="2023-01-01">
                            </div>
                        </div>
                        ...
                        <div class="col-6  col-lg-2">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="0" class="form-control form-control-sm" step="0.01"
                                    id="iptPrecioCompraReg" placeholder="P. de Compra" required>
                        ...
                        <div class="col-6  col-lg-2">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="0" class="form-control form-control-sm" id="iptPrecioVentaReg"
                                    placeholder="P. Venta" step="0.01" required>
                        ...
                        <div class="col-6  col-lg-2">
                            <div class="form-group mb-2">
                                <label class="" for="iptPrecioMayorReg"><i class="fas fa-dollar-sign fs-6"></i> <span
                                        class="small">Precio por Mayor</span></label>
                                <input type="number" min="0" class="form-control form-control-sm" id="iptPrecioMayorReg"
                                    placeholder="P. por Mayor" disabled>
                            </div>
                        </div>
                        <!-- Columna para registro de la Precio Oferta -->
                        <div class="col-6  col-lg-2">
                            <div class="form-group mb-2">
                                <label class="" for="iptPrecioOfertaReg"><i class="fas fa-dollar-sign fs-6"></i> <span
                                        class="small">Precio Oferta</span></label>
                                <input type="number" min="0" class="form-control form-control-sm"
                                    id="iptPrecioOfertaReg" placeholder="P. Oferta" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-lg-1">
                            <div class="form-check">
                                ...
                                <label class="form-check-label mb-2" for="chkIva"><span
                                        class="small d-block">Impuesto</span></label>
                            </div>
                        </div>
...
function calcularUtilidad() {
    ...
    var iptPrecioMayorReg = iptPrecioVentaReg - (iptPrecioVentaReg * 0.20);
    var iptPrecioOfertaReg = iptPrecioVentaReg - (iptPrecioVentaReg * 0.40);
