...
if (isset($_POST['accion']) && $_POST['accion'] == 1) { // parametro para listar productos
    ...
    $registrarProducto->ubicacion_producto = $_POST["ubicacion_producto"];
    $registrarProducto->fecha_vencimiento_producto = $_POST["fecha_vencimiento_producto"];
    ...
    $registrarProducto->precio_mayor_producto = $_POST["precio_mayor_producto"];
    $registrarProducto->precio_oferta_producto = $_POST["precio_oferta_producto"];
    $registrarProducto->utilidad = $_POST["utilidad"];
    $registrarProducto->impuesto_producto_iva = $_POST["impuesto_producto_iva"];
    ...
    $data = array(
        ...
        "impuesto_producto_iva" => $_POST["impuesto_producto_iva"],
