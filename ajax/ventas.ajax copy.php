...
class AjaxVentas
{
    ...
    public function ajaxRegistrarVenta($datos, $nro_boleta, $total_venta, $descripcion_venta, $numero_ruc_cliente, $nombres_apellidos_razon_social_cliente, $email_cliente)
    {
        $registroVenta = VentasControlador::ctrRegistrarVenta($datos, $nro_boleta, $total_venta, $descripcion_venta, $numero_ruc_cliente, $nombres_apellidos_razon_social_cliente, $email_cliente);
...
if (isset($_POST["accion"]) && $_POST["accion"] == 1) {
    ...
    if ((isset($_POST["arr"]))) {
        ...
        $registrar->ajaxRegistrarVenta(
            $_POST["arr"],
            $_POST['nro_boleta'],
            $_POST['total_venta'],
            $_POST['descripcion_venta'],
            $_POST['numero_ruc_cliente'],
            $_POST['nombres_apellidos_razon_social_cliente'],
            $_POST['email_cliente']
        );
    }
}
